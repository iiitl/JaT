...
public class Client {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("This chat system is like a walkie talkie, you (client) and the server get turns to send a 1 line message at a time. Send \"" + endCodeWord + "\" to end the session anytime!");
            while(true) {
